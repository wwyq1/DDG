...
class Metric:
    ...
    def __init__(self, task_name: str):
        ...
        #*DATASET_ATTRS[task_name]["metric_args"])
...
class EvaluatorForFewShot(Evaluator):
    ...
    def evaluate_learner(
        ...
        for batch in tqdm(
            ...
            assert (
                batch["input_ids"].shape[1] <= learner.module.tokenizer.model_max_length
    ...
    def get_model_probs(
        ...
        assert (
            batch["input_ids"].shape[1] <= learner.module.tokenizer.model_max_length
        ), f"{batch['input_ids'].shape[1]} > {learner.module.tokenizer.model_max_length}"
