...
login(token="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")
...
dataset = load_dataset("/root/ww-xd/LongICLBench/agnews/")
train_data = dataset['train']
test_data = dataset['test']
demo_data = select_data(given_dataset=train_data, number_of_turns=args.round)
eva_data = select_data(given_dataset=test_data, number_of_turns=10)
total = 0
correct = 0
